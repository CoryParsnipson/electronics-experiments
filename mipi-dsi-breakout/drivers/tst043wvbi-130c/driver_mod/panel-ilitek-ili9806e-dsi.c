...
//
// This is a modified version of the "panel-ilitek-ili9806e.c" driver in the raspberry pi source repo.
// https://github.com/raspberrypi/linux/blob/rpi-6.12.y/drivers/gpu/drm/panel/panel-ilitek-ili9806e.c
//
// That version is compatible with the 6.21.x kernel, while the system I'm running on is on 6.12.y. To
// make this compile and load, I've added a bunch of *_multi functions from the drm_mipi_dsi.h into
...
/*
 * "polyfills" for dsi multi additions not in this kernel version
 */
...
static int ili9806e_dsi_probe(struct mipi_dsi_device *dsi)
{
	...
	// drm_panel does not implement prepare_prev_first here, so lets
	// comment it out and hope it still works for now...
