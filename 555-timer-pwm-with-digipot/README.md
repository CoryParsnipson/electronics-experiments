...
![Min and Max Duty Cycle of Built 555-timer](/images/555-timer-pwm-with-digipot/555-timer-min-max.gif?raw=true)
...
![Raspberry Pi PWM signal demonstration](/images/555-timer-pwm-with-digipot/rpi-pwm-breathe.gif?raw=true)
